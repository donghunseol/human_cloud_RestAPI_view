...
values ('ssar', '1234', '김진환', '01012345678', '010101', 'ssar@nate.com', '쌀도 쌀시 쌀구 쌀동', null, 0, now());
insert into user_tb(username, password, name, tel, birth, email, address, image, role, created_at)
values ('cos', '1234', '온빛나', '01087654321', '020202', 'cos@nate.com', '코스도 코스시 코스구 코스동', null, 0, now());
insert into user_tb(username, password, name, tel, birth, email, address, image, role, created_at)
values ('love', '1234', '제갈민지', '01012341234', '030303', 'love@nate.com', '러브도 러브시 러브구 러브동', null, 0, now());
insert into user_tb(username, password, name, tel, birth, email, address, image, role, created_at)
values ('hello', '1234', '남궁채', '01012341234', '030303', 'love@nate.com', '러브도 러브시 러브구 러브동', null, 0, now());
-- 기업
insert into user_tb(username, password, name, tel, birth, email, address, image, role, created_at)
...
values (7, '(주)리드미', '고용형태1', '개발분야1', '근무지1', '공고 내용1', '20240303',now());
insert into notice_tb(user_id, title, type, field, work_place, content, deadline, created_at)
values (5, '리더온', '고용형태2', '개발분야2', '근무지2', '공고 내용2', '20240404', now());
insert into notice_tb(user_id, title, type, field, work_place, content, deadline, created_at)
values (7, 'GGO', '고용형태3', '개발분야3', '근무지3', '공고 내용3', '20240505', now());
insert into notice_tb(user_id, title, type, field, work_place, content, deadline, created_at)
values (5, '프베나', '고용형태4', '개발분야4', '근무지4', '공고 내용4', '20240606', now());
insert into notice_tb(user_id, title, type, field, work_place, content, deadline, created_at)
values (6, '다름시', '고용형태5', '개발분야5', '근무지5', '공고 내용5', '20240707', now());
